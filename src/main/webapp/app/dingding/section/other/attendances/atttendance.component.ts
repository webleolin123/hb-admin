import {Component, OnDestroy, OnInit,ElementRef,Renderer2,ViewChild,AfterViewInit} from '@angular/core';
...
import {
    BASE_API_URL, WORKFLOW_TO_ATTENDANCE_API,
...
import {LogService,CommonMethodsService} from "../../../../common/index";
@Component({
...
export class AttendanceComponent implements OnInit, OnDestroy,AfterViewInit {
    ...
    uploader: FileUploader = new FileUploader({
        url: BASE_API_URL + WORKFLOW_TO_ATTENDANCE_API,
    });
    ...
    constructor(
        ...
        this.attendanceService.resourceUrl=WORKFLOW_TO_AperationSates_Attendance_API;
        this.attendanceService.resourceUrl_search=WORKFLOW_TO_Attendance_Search_API;
        this.itemsPerPage = 10;
        this.page = 1;
        this.previousPage = 1;
        this.yearValue=0;
        this.monthValue=0;
        this.yearChoiceArr=['2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022','2023'];
        this.monthChoiceArr=['01','02','03','04','05','06','07','08','09','10','11','12'];
    }
    ngOnInit() {
    ...
    ngAfterViewInit(){
        this.renderer2.setStyle(this.selectYear.nativeElement, 'text-align', 'center');
        this.renderer2.setStyle(this.selectMonth.nativeElement, 'text-align', 'center');
    }
    ngOnDestroy() {
    ...
    loadAll(){
        this.router.navigate(['/dingding/section/attendance'], {
            queryParams: {
                page: this.page - 1,
    ...
    showDetail(keyCode){
        ...
        this.attendanceService.approverCommonId =keyCode;
    }
    export() {
    ...
    onQueryExportDataSuccess(data: Department[]) {
        ...
        this.toasterService.popAsync(toast);
        data.forEach((rootDept: Department,) => {
    ...
    exportUsers4CSV() {
        ...
        this.attendanceService.exportCsv({
