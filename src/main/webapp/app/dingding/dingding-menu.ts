...
export const SECTIONS_ITEMS: NbMenuItem[] = [
    {
        title: '首页',
        icon: 'nb-home',
        link: '/dingding/home',
...
export const ROLES_USER_ITEMS: NbMenuItem[] = [
    {
        title: '首页',
        icon: 'nb-home',
        link: '/dingding/home',
...
export const ROLES_FINANCE_ITEMS: NbMenuItem[] = [
    {
        title: '首页',
        icon: 'nb-home',
        link: '/dingding/home',
...
export const ROLES_HR_ITEMS: NbMenuItem[] = [
    {
        title: '首页',
        icon: 'nb-home',
        link: '/dingding/home',
